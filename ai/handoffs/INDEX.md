...
# Handoff Index / Индекс handoff

Read this index first. Do not read all handoff files blindly.
Сначала читайте этот индекс. Не читайте все handoff-файлы подряд.

| Date | Updated | Run | Issue | PR | Branch | Status | Relevance | Summary | File | Supersedes |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-07-02 | 2026-07-02 | repository-presentation | none | none | main | completed | active | Added landing README, community docs, FAQ mirrors, examples, promotion checklist, repository settings guide, and social preview asset | | consistency-pass |
...
| 2026-06-29 | 2026-06-29 | initial-standard-1-1 | #1 | TBD | ai-handoff-standard-1-1 | completed | historical | Added initial standard structure | 2026-06-29_issue-1_pr-tbd_run-initial-standard-1-1.md | |
